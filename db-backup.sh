...
function usage() {
  ...
  $echo "  -e | --git_user_name [name]           Input the git user name, required when use http protocol"
  $echo "  -w | --git_user_pwd [pwd]             Input the git user pwd, required when use http protocol"
  $echo "  -i | --git_user_email [email]         Input the git user email, required when use http protocol"
  $echo "  -r | --git_remote [remote]            Input the git remote, accept http | ssh protocol"
  $echo "  -b | --git_branch [branch]            Input the git branch, default master"
  $echo ""
